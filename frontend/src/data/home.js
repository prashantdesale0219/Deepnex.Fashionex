...
export const statsData = [
    ...
    },
    {
        id: 5,
        value: "+30%",
        title: "In ad click-through rates",
    }
]
...
export const testimonialData = [
    {
        ...
        position: "Co-Founder, ENDER LEGARD",
        company: "ENDER LEGARD",
        companyLogo: "/assets/images/slider1.webp",
        image: "/assets/images/slider1.webp",
        testimonial: "Absolutely love this app. I've been searching and sampling many apps to change the models on my product images and none of them do it properly until I started using BOTIKA. This app is unbelievable and does 100% what I am after."
    },
    {
        id: 2,
        name: "Sarah Johnson",
        position: "Marketing Director, HYPE",
        company: "HYPE",
        companyLogo: "/assets/images/slider2.webp",
        image: "/assets/images/slider2.webp",
        testimonial: "By far, the customer service app is unmatched. It's a big cost saver for us as the app keeps developing, evolving."
    },
    {
        id: 3,
        name: "Michael Chen",
        position: "Creative Director, Fashion Forward",
        company: "Fashion Forward",
        companyLogo: "/assets/images/slider3.webp",
        image: "/assets/images/slider3.webp",
        testimonial: "We've cut our production time in half and increased our catalog variety by 300%. The AI models look incredibly realistic and our customers love the diversity."
    },
    {
        id: 4,
        name: "Emma Rodriguez",
        ...
        company: "StyleHub",
        companyLogo: "/assets/images/slider4.webp",
        image: "/assets/images/slider4.webp",
        testimonial: "The background swap feature alone has saved us thousands in photoshoot costs. We can now create seasonal campaigns in minutes instead of weeks."
    },
    {
        id: 5,
        name: "David Kim",
        position: "CEO, TrendSetters",
        company: "TrendSetters",
        companyLogo: "/assets/images/slider5.webp",
        image: "/assets/images/slider5.webp",
        testimonial: "As a small business, we couldn't afford professional models. FashionX has leveled the playing field, allowing us to compete with major brands on visual quality."
    }
]